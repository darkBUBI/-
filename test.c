...
//========================variable==========================//
unsigned short int ColorTab[5]={RED,GREEN,BLUE,YELLOW,BRED};//定义颜色数组
//=====================end of variable======================//

/*****************************************************************************
 * @name       :void DrawTestPage(unsigned char *str)
 * @date       :2018-08-09 
 * @function   :Drawing test interface
 * @parameters :str:the start address of the Chinese and English strings
 * @retvalue   :None
******************************************************************************/ 
void DrawTestPage(unsigned char *str)
{
//绘制固定栏up
LCD_Clear(WHITE);
...
//{
//	unsigned char i=0;
//	unsigned char *Direction[4]={"Rotation:0","Rotation:90","Rotation:180","Rotation:270"};
//
//	for(i=0;i<4;i++)
//	{
//	LCD_direction(i);
...
void Touch_Test(void)
{
	...
	unsigned short int colorTemp=0;
	TP_Init();
//	KEY_Init();
//	LED_Init();
...
//	 	key=KEY_Scan(1);
		tp_dev.scan(0); 		 
		if(tp_dev.sta&TP_PRES_DOWN)			//触摸屏被按下				TP_PRES_DOWN=0X80
		{	
...
//				delay_ms(10);
		...
		}else LL_mDelay(10);//delay_ms(10);	//没有按键按下的时候
