...
/*****************************************************************************
 * @name       :void TP_Write_Byte(unsigned char num)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :unsigned short int TP_Read_AD(unsigned char CMD)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :unsigned short int TP_Read_XOY(unsigned char xy)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :unsigned char TP_Read_XY(unsigned short int *x,unsigned short int *y)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :unsigned char TP_Read_XY2(unsigned short int *x,unsigned short int *y)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void TP_Drow_Touch_Point(unsigned short int x,unsigned short int y,unsigned short int color)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void TP_Draw_Big_Point(unsigned short int x,unsigned short int y,unsigned short int color)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :unsigned char TP_Scan(unsigned char tp)
 * @date       :2018-08-09 
...
{			   
//	if(PEN==0)//有按键按下
	if(GPIOreadPin(GPIOC, 0)==0)//有按键按下
	{
...
/*****************************************************************************
 * @name       :unsigned char TP_Get_Adjdata(void)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void TP_Adj_Info_Show(unsigned short int x0,unsigned short int y0,unsigned short int x1,unsigned short int y1,unsigned short int x2,unsigned short int y2,unsigned short int x3,unsigned short int y3,unsigned short int fac)
 * @date       :2018-08-09 
...
{								 
  ...
  LCD_ShowString(10,104,16,"is completed.",1);//显示提示信息
	...
	while(1)//如果连续10秒钟没有按下,则自动退出
	{
		...
		if((tp_dev.sta&0xc0)==TP_CATH_PRES)//按键按下了一次(此时按键松开了.)TP_CATH_PRES=0100
		{	
			outtime=0;		
...
/*****************************************************************************
 * @name       :unsigned char TP_Init(void)
 * @date       :2018-08-09 
