...
uint8_t buf[50];
/*******************************************************************
 * @name       :void GUI_DrawPoint(unsigned int x,unsigned int y,unsigned int color)
 * @date       :2018-08-09 
...
/*******************************************************************
 * @name       :void LCD_Fill(unsigned int sx,unsigned int sy,unsigned int ex,unsigned int ey,unsigned int color)
 * @date       :2018-08-09 
...
{  	
	unsigned int i,j;
	unsigned int width=ex-sx+1; 		//�õ����Ŀ��
	unsigned int height=ey-sy+1;		//�߶�
...
/*******************************************************************
 * @name       :void LCD_DrawLine(unsigned int x1, unsigned int y1, unsigned int x2, unsigned int y2)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void LCD_DrawRectangle(unsigned int x1, unsigned int y1, unsigned int x2, unsigned int y2)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void LCD_DrawFillRectangle(unsigned int x1, unsigned int y1, unsigned int x2, unsigned int y2)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void _draw_circle_8(int xc, int yc, int x, int y, unsigned int c)
 * @date       :2018-08-09 
 ...
 * @retvalue   :None
******************************************************************************/  
void _draw_circle_8(int xc, int yc, int x, int y, unsigned int c)
{
...
/*****************************************************************************
 * @name       :void gui_circle(int xc, int yc,unsigned int c,int r, int fill)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void Draw_Triangel(unsigned int x0,unsigned int y0,unsigned int x1,unsigned int y1,unsigned int x2,unsigned int y2)
 * @date       :2018-08-09 
...
static void _swap(unsigned int *a, unsigned int *b)
{
	unsigned int tmp;
  tmp = *a;
	*a = *b;
...
/*****************************************************************************
 * @name       :void Fill_Triangel(unsigned int x0,unsigned int y0,unsigned int x1,unsigned int y1,unsigned int x2,unsigned int y2)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void LCD_ShowChar(unsigned int x,unsigned int y,unsigned int fc, unsigned int bc, unsigned char num,unsigned char size,unsigned char mode)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void LCD_ShowString(unsigned int x,unsigned int y,unsigned char size,unsigned char *p,unsigned char mode)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :unsigned long int mypow(unsigned char m,unsigned char n)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void LCD_ShowNum(unsigned int x,unsigned int y,unsigned long int num,unsigned char len,unsigned char size)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void GUI_DrawFont16(unsigned int x, unsigned int y, unsigned int fc, unsigned int bc, unsigned char *s,unsigned char mode)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void GUI_DrawFont24(unsigned int x, unsigned int y, unsigned int fc, unsigned int bc, unsigned char *s,unsigned char mode)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void GUI_DrawFont32(unsigned int x, unsigned int y, unsigned int fc, unsigned int bc, unsigned char *s,unsigned char mode)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void Show_Str(unsigned int x, unsigned int y, unsigned int fc, unsigned int bc, unsigned char *str,unsigned char size,unsigned char mode)
 * @date       :2018-08-09 
...
/*****************************************************************************
 * @name       :void Gui_StrCenter(unsigned int x, unsigned int y, unsigned int fc, unsigned int bc, unsigned char *str,unsigned char size,unsigned char mode)
 * @date       :2018-08-09 
...
void Gui_StrCenter(unsigned int x, unsigned int y, unsigned int fc, unsigned int bc, unsigned char *str,unsigned char size,unsigned char mode)
{
	...
	unsigned int x1=(lcddev.width-len*8)/2;
	Show_Str(x1,y,fc,bc,str,size,mode);
} 
 
/*****************************************************************************
 * @name       :void Gui_Drawbmp16(unsigned int x,unsigned int y,const unsigned char *p)
 * @date       :2018-08-09 
...
void Show_Online(uint8_t num){
	sprintf(buf,"%d号 在线  ",num);
	Show_Str(10, 10+(num-1)*30, BLUE, WHITE, buf, 32, 0);
}
void Show_Offline(uint8_t num){
	sprintf(buf,"%d号 不在线",num);
	Show_Str(10, 10+(num-1)*30, RED, WHITE, buf, 32, 0);
}
